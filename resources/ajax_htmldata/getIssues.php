...
?>
	...
	<table id="downTimeTable" class='linedFormTable issueTabTable'>
		...
		<tr>
			<td><a id="createDowntimeBtn" class="thickbox" href="ajax_forms.php?action=getNewDowntimeForm&resourceID=<?php echo $resourceID; ?>&height=264&width=390&modal=true">report new Downtime</a></td>
		</tr>
		<tr>
			<td>
