...
switch ($action) {
    ...
    case 'getLogEmailAddressTable':
		...
		foreach($logEmailAddresses->allAsArray as $logEmailAddress) {
			...
			echo "<td><a href='ajax_forms.php?action=getLogEmailAddressForm&height=122&width=248&logEmailAddressID=" . $logEmailAddress['logEmailAddressID'] . "&modal=true' class='thickbox'><img id='Edit' class='editIcon' src='images/edit.gif' title= '"._("Edit")."' /></a></td>";
			echo "<td><a href='javascript:deleteLogEmailAddress(" . $logEmailAddress['logEmailAddressID'] . ");'><img id='Remove' class='removeIcon' src='images/cross.gif' title= '"._("Delete")."' /></a></td></tr>";
		}
		...
		if (count($user->allAsArray()) > 0){
			...
			<table class='dataTable' style='width:550px'>
				...
				foreach($user->allAsArray() as $instance) {
					...
					echo "<td style='width:30px'><a href='ajax_forms.php?action=getAdminUserUpdateForm&loginID=" . $instance['loginID'] . "&height=196&width=248&modal=true' class='thickbox' id='expression'><img id='Update' class='updateIcon' src='images/arrow_up.gif' title= '"._("Update")."' /></a></td>";
