...
elseif ((isset($_POST[$root_installation_namespace . "_options_button"]) && $_POST[$root_installation_namespace . "_options_button"] !== "install_anyway") || !isset($_POST[$root_installation_namespace . "_options_button"]))
{
	$option_button_set = [
	...
	if (version_compare(INSTALLATION_VERSION, $old_version) > 0)
	{
		...
		$instruction = _("This installer installs a newer versino of CORAL than the one currently installed. This is <b>highly discouraged</b> and will probably result in the loss of data. Instead you should try to upgrade.");
